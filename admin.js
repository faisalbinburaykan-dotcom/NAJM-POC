                    ...
                    <div class="ticket-files-row">
                        ${uploads.accident_photos.map(photo => `
                            <div class="ticket-file-card">
                                ...
                                <button type="button"
                                        onclick="window.open('http://localhost:3000${photo.url}', '_blank')"
            ...
            <div style="margin-bottom: 16px; margin-top: 20px;">
                ...
                <div class="ticket-files-row">
                    ...
                    <div class="ticket-file-card">
                        ...
                        ${uploads.id_card ? `
                            <button type="button"
                                    onclick="window.open('http://localhost:3000${uploads.id_card.url}', '_blank')"
                                    class="ticket-file-btn">
                                ${currentLanguage === 'ar' ? 'عرض' : 'View'}
                            </button>
                        ` : `
                    ...
                    <div class="ticket-file-card">
                        ...
                        ${uploads.driving_license ? `
                            <button type="button"
                                    onclick="window.open('http://localhost:3000${uploads.driving_license.url}', '_blank')"
                                    class="ticket-file-btn">
                                ${currentLanguage === 'ar' ? 'عرض' : 'View'}
                            </button>
                        ` : `
                    ...
                    <div class="ticket-file-card">
                        ...
                        ${uploads.vehicle_registration ? `
                            <button type="button"
                                    onclick="window.open('http://localhost:3000${uploads.vehicle_registration.url}', '_blank')"
                                    class="ticket-file-btn">
                                ${currentLanguage === 'ar' ? 'عرض' : 'View'}
                            </button>
                        ` : `
